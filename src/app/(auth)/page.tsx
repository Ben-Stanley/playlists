    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-4 pb-20 gap-16 sm:p-20">
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start sm:w-96 h-full">
        <div className="w-full text-center space-y-2">
          ...
          <p className="text-lg">
            Create and manage your playlists with ease.
          </p>
        </div>
        ...
        <Card className="w-full">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="mt-8 flex flex-col gap-4">
            <FieldItem label="Email" htmlFor="email" error={errors.email?.message}>
              <Input {...register("email")} type="text" name="email" placeholder="Enter your email" />
            </FieldItem>

            <FieldItem label="Password" htmlFor="password" error={errors.password?.message}>
              <Input {...register("password")} type="password" name="password" placeholder="Enter your password" />
            </FieldItem>
